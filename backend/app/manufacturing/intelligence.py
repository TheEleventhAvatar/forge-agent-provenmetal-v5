...
def requirement_quality(req, pcb=None):
    ...
    for key,value in req.items():
        ...
        if value is None or value==[]:
            result[key]={"status":"UNKNOWN","reason":"The input does not contain enough data to extract this requirement."}
